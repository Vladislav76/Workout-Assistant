...
public class WorkoutGroupAdapter extends RecyclerView.Adapter<WorkoutGroupAdapter.WorkoutsCardViewHolder> {
    ...
    private OnItemClickCallback mWorkoutGroupCallback;
    private OnItemClickCallback mWorkoutCallback;
    private RecyclerView.RecycledViewPool mViewPool; //for the same view types

    public WorkoutGroupAdapter(OnItemClickCallback workoutGroupCallback, OnItemClickCallback workoutCallback) {
