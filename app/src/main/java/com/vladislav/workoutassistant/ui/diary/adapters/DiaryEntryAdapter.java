package com.vladislav.workoutassistant.ui.diary.adapters;
...
public class DiaryEntryAdapter extends RecyclerView.Adapter<DiaryEntryAdapter.DiaryEntryViewHolder> {
    ...
    private OnDiaryEntryClickCallback mCallback;

    public DiaryEntryAdapter(Application application, @Nullable OnDiaryEntryClickCallback callback, boolean isSelectedMode) {
        mCallback = callback;
