package com.vladislavmyasnikov.workout_library_and_player_impl.presentation.workout_execution.workout_result.content
...
class WorkoutResultContent @Inject constructor(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ok_button.setOnClickListener { sendMessage(Messages.TransitionRequestMessage) }
        viewModel.request()
    }
