package com.vladislavmyasnikov.feature_exercise_library_impl.presentation.exercise_list.dialog
...
class ExerciseFiltrationDialog : DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(selectedItemsIDs: IntArray): ExerciseFiltrationDialog {
            return ExerciseFiltrationDialog().apply {
