package com.vladislavmyasnikov.feature_workout_library_impl.presentation.completed_workout_details.host
...
class CompletedWorkoutScreenHost @Inject constructor(
    ...
    override fun onAttach(context: Context) {
        fragmentFactory = WorkoutLibraryFeatureComponent.get().completedWorkoutComponent.getValue().fragmentFactory
        super.onAttach(context)
    }

    override fun onBackPressed(): Boolean {
        if (super.onBackPressed()) WorkoutLibraryFeatureComponent.get().completedWorkoutComponent.resetValue()
        return true
    }
